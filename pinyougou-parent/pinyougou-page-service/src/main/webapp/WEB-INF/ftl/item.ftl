            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        <#list specificationList as list>
                            <dl>
                                <dt>
                                    <div class="fl title">
                                ...
                                <#list list.attributeValue as spec>
                                    <dd><a class="{{isSelected('${list.attributeName}','${spec}')?'selected':''}}"
                                           ng-click="specificationSelect('${list.attributeName}','${spec}')"
                                           href="javascript:;">${spec}<span title="点击取消选择">&nbsp;</span></a></dd>
                                </#list>
                            </dl>
                        </#list>
                    </div>
